...
import { Plus, Trash2, Star, Save, Upload, Image as ImageIcon } from 'lucide-react'
  ...
  const fetchCourse = async () => {
    try {
      ...
      setFormData({
        ...
        projects: course.projects?.length ? course.projects.map(p => (typeof p === 'string' ? p : p.title || '')) : [''],
        interviewPrep: course.interviewPrep?.length ? course.interviewPrep : [''],
        dsaPractice: course.dsaPractice?.length ? course.dsaPractice : [''],
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8 flex items-center">
          <Save className="h-7 w-7 mr-3 text-primary-600" />Edit Course
        </h1>
